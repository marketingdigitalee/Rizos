		...
		<article class="boxVideo">
			<div class="imgVideo" style="background-image: url(img/7.jpg);">
		      	<ul id="video2">
					<li>
						<a data-fancybox data-fancybox="iframe" href="https://youtu.be/VOu8YLKd2-Y">
		...
		<article class="boxVideo">
			<div class="imgVideo" style="background-image: url(img/6.jpg);">
		      	<ul id="video2">
					<li>
						<a data-fancybox data-fancybox="iframe" href="https://youtu.be/zlPxhDuGw0M">
							<img class="play" src="img/play.png" alt="">
						</a>
					</li>
				</ul>
		...
		<article class="boxVideo">
			<div class="imgVideo" style="background-image: url(img/5.jpg);">
		      	<ul id="video2">
					<li>
						<a data-fancybox data-fancybox="iframe" href="https://youtu.be/EMSIIjEYOLU">
							<img class="play" src="img/play.png" alt="">
						</a>
					</li>
				</ul>
