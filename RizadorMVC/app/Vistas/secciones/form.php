	...
	<div class="login-page">
		<div class="form">
				...
				<form action="index.php#ReservaYA" method="post">
					...
					<input name="telUsuario" onkeyup="var no_digito = /\D/g; this.value = this.value.replace(no_digito , '');" type="text" placeholder="Telefono fijo" >
					<input type="text" placeholder="Telefono Celular" name="celUsuario" required="true" onkeyup="var no_digito = /\D/g; this.value = this.value.replace(no_digito , '');">
