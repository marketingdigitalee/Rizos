				...
				<form action="config.php" method="post">
						<div class="">
								...
								<input type="text" name="nomUsuario" required="true" placeholder="Nombre" >
					  			...
					  			<input type="text" name="cedulaUsuario" required="true" placeholder="Cédula" onkeyup="var no_digito = /\D/g; this.value = this.value.replace(no_digito , '');" >
								...
								<input type="text" name="cedulaRecoje" placeholder="Nùmero de cedula de quien recoje el producto" onkeyup="var no_digito = /\D/g; this.value = this.value.replace(no_digito , '');" >
